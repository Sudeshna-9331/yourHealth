...
<body>
    ...
    <div class="section container-fluid">
        ...
        <div class="container body mb-1">
            ...
            <?php
                ...
                echo '
                    <div class="card">
                        <img src="https://source.unsplash.com/1600x900/?' .$row['category_name']. ',medical,medicine" class="card-img-top"
                            >
                        <div class="card-body">
                            <h5 class="card-title" style="font-weight: bold; color: grey;"><a href="threads.php?catid='.$row['category_id'].'">'.$row['category_name'].'</a></h5>
    ...
    <div class="container-fluid why-us" id="why-us">
        ...
        <div class="why-us-inner">
            <h2>Why Us?</h2>
            <p class="p">We are a team providing the opportunity for online consultation with health experts virtually
                for the patients in this ongoing Covid situatiion...You ask your queries and complications,our experts
                will solve them. If not you can contact us,we will connect with you.</p>
